<template>
  <div class="docs-body container-lg mx-auto">
    ...
    <DemoBlock class="mt-3">
      <bs-alert v-model="dismissibleAlert1" color="teal" dismissible>
        This is a dismissible alert.
      </bs-alert>
      <bs-alert v-model="dismissibleAlert2" @close="closeAlert" dismissible>
      ...
      <div class="row">
        <div class="col-12 col-md-6 mb-3 mb-md-0">
          <BsButton color="primary" @click="toggleAlert">
            {{ dismissibleAlert1 ? 'Hide' : 'Show' }} dismissible Alert
          </BsButton>
        </div>
        <div class="col-12 col-md-6 mb-3 mb-md-0">
          <BsButton color="primary" @click="showAlert">Show Alert with timer</BsButton>
        </div>
      </div>
    </DemoBlock>
  </div>
...
const dismissibleAlert1 = ref(false);
const dismissibleAlert2 = ref(false);
...
function toggleAlert() {
  dismissibleAlert1.value = !dismissibleAlert1.value;
}
